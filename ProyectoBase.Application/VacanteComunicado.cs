...
namespace ProyectoBase.Application
{
    ...
    {
        Data.VacanteComunicado _VacanteComunicado = new Data.VacanteComunicado();
        ...
        public Models.VacanteComunicado VacanteComunicado_Agregar(Models.VacanteComunicado vacanteComunicado)
        {
            ...
            Models.VacanteComunicado dbvacanteComunicado = _VacanteComunicado.VacanteComunicado_Agregar(vacanteComunicado);
            Models.Consultas.VacanteUsuario dbvacanteUsuario = _Vacante.Vacante_Seleccionar_Usuario_IdVacante(vacanteComunicado.Vacante);

            // ENVIO DE CORREO ELECTRONICO
            if (dbvacanteComunicado.Id > 0)
            {
                correo1.CorreoMetPrivado("mail.asae.com.mx", 25, "soporte-aplicaciones@asae.com.mx", "$%65hgy#19_",
                        dbvacanteUsuario.EMails.Email, "Asae Consultores S.A de C.V", "Modificación de vacante de trabajo - " + vacanteComunicado.Titulo, CorreoCominicado(dbvacanteUsuario, vacanteComunicado));
            }
            
            return dbvacanteComunicado;
        }

        public string CorreoCominicado(Models.Consultas.VacanteUsuario dbvacanteUsuario, Models.VacanteComunicado vacanteComunicado)
        {
            string IdVacante = Application.UrlCifrardo.Encriptar(dbvacanteUsuario.Vacante.Id.ToString());
 ...
 <body style=""width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"">
  <div class=""es-wrapper-color"" style=""background-color:#EFEFEF""><!--[if gte mso 9]>
   ...
   <table class=""es-wrapper"" width=""100%"" cellspacing=""0"" cellpadding=""0"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#EFEFEF"">
                     ...
                     <tr>
                      <td align=""left"" class=""es-m-txt-c es-m-p0r es-m-p0l"" style=""padding:0;Margin:0;padding-left:40px;padding-right:40px""><p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:39px;color:#455A64;font-size:26px;text-align:center"">
                        ...
                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px;text-align:center"">
                            <br>
                            Estimado/a <strong>Estimado {dbvacanteUsuario.Personas.Nombre + " " + dbvacanteUsuario.Personas.ApPaterno + " " + dbvacanteUsuario.Personas.ApMaterno} </strong>
                            <br>
                        </p>
                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px;text-align:justify"">
                            Me pongo en contacto con usted para informarle que se requiere de su apoyo para modificar la vacante de trabajo <strong> {dbvacanteUsuario.Vacante.Titulo} </strong>
                        </p>
                        ...
                        -- Observaciones : <br> { vacanteComunicado.Observaciones }
                        <br>
                        </p>
                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px"">
                           <br> Apreciamos su interés y apoyo en este proceso de selección. Estaremos atentos a los avances y mantendremos informado al equipo de proyecto sobre cualquier actualización relevante.
                        </p>
                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px"">
                            <br> En caso de que tenga alguna pregunta, no dude en ponerse en contacto conmigo.
                        </p>
                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px"">
                            <br><br>
                        </p>
	...
	<v:roundrect xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:w=""urn:schemas-microsoft-com:office:word"" esdevVmlButton href=""https://www.asae.com.mx/Vacantes/VacanteEditar?Id={IdVacante}"" 

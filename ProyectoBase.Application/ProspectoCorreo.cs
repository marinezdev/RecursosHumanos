...
namespace ProyectoBase.Application
{
    public class ProspectoCorreo
    {
        ...
        {
            Models.ProspectoCorreo dbprospectoCorreo = _ProspectoCorreo.ProspectoCorreo_Agregar(prospectoCorreo);

            if(dbprospectoCorreo.Id > 0)
            {
                Models.Consultas.ProspectoCorreos prospectoCorreos = _ProspectoCorreo.ProspectoCorreo_Seleccionar_Id(dbprospectoCorreo);
                EmailEnvioProspectoCorreo(prospectoCorreos);
            }
            return dbprospectoCorreo;
        }
        public List<Models.ProspectoCorreo> ProspectoCorreo_Seleccionar_IdVacante(Models.Vacante vacante)
        {
            return _ProspectoCorreo.ProspectoCorreo_Seleccionar_IdVacante(vacante);
        }
        ...
        {
            return _ProspectoCorreo.ProspectoCorreo_Actualizar(prospectoCorreo);
        }
        public Models.ProspectoCorreo Prospecto_EliminarCorreo(Models.ProspectoCorreo ProspectoCorreo)
        {
            return _ProspectoCorreo.Prospecto_EliminarCorreo(ProspectoCorreo);
        }




        public bool EmailEnvioProspectoCorreo(Models.Consultas.ProspectoCorreos prospectoCorreos)
        {
            bool result = false;

            WSCorreo.CorreoSoapClient correo1 = new WSCorreo.CorreoSoapClient();
            correo1.CorreoMetPrivado("mail.asae.com.mx", 25, "soporte-aplicaciones@asae.com.mx", "$%65hgy#19_", prospectoCorreos.Prospecto.CorreElectronico, "Asae Consultores S.A de C.V", "Postulación vacante " + prospectoCorreos.Vacante.Titulo , EnvioProspectoCorreo(prospectoCorreos));
            
            return result;
        }

        public string EnvioProspectoCorreo(Models.Consultas.ProspectoCorreos prospectoCorreos)
        {
            string Html = $@"
                                               ...
                                               <table cellpadding=""0"" cellspacing=""0"" width=""100%"" role=""presentation"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"">
                                                 <tr>
                                                    <td align=""left"" class=""es-m-txt-c es-m-p0r es-m-p0l"" style=""padding:0;Margin:0;padding-left:40px;padding-right:40px"">
                                                        ...
                                                        <br>
                                                            Estimado/a  <strong> {prospectoCorreos.Prospecto.Nombre + " " + prospectoCorreos.Prospecto.ApellidoPaterno + " " + prospectoCorreos.Prospecto.ApellidoMaterno } </strong>
                                                        </p>
                                                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px;text-align:justify"">
                                                            Me pongo en contacto con usted para informarle sobre la vacante que usted se postulo <strong> { prospectoCorreos.Vacante.Titulo } </strong>
                                                        </p>
                                                        ...
                                                        <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#455A64;font-size:14px;text-align:left"">
                                                            Mensaje : <br> {prospectoCorreos.ProspectoCorreo.Correo}
                                                        <br>
                                                        </p>
